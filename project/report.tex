...
\begin{figure}[ht!]
  ...
  \hspace*{-3cm}
  \begin{subfigure}{.5\paperwidth}
  \includegraphics[width=0.5\paperwidth]{winter-nh-eof.pdf}
...
seen in Fig.\ref{fig:freq}-a, there is a string signal at
...
\begin{figure}[ht!]
  ...
  \hspace*{-3cm}
  \begin{subfigure}{.5\paperwidth}
  \includegraphics[width=0.5\paperwidth]{pc1-fourier.pdf}
...
scatterplot as shown in Fig.\ref{fig:darwin-tahiti-scatter} the correlation
is quite strong (0.8).

\begin{figure}[ht!]
  \centering
  \includegraphics[width=0.4\paperwidth]{darwin-tahiti-scatter.pdf}
  \caption{Scatter plot of normalised mslp at Darwin and Tahiti.}
  \label{fig:darwin-tahiti-scatter}
\end{figure}

If we investigate PC1 further we can do a fourier transformation and
see if we can find any perodicity. 
